            ...
            <div className="bg-slate-800 rounded-xl shadow-2xl w-full max-w-4xl max-h-[90vh] flex flex-col" onClick={e => e.stopPropagation()}>
                ...
                <div className="overflow-y-auto p-6">
                    <div className="mb-6 p-4 bg-slate-900/50 rounded-lg border border-slate-700">
                        ...
                        <p className="text-sm text-slate-400 mb-3">The AI determined the primary topic of this page is: <span className="font-semibold text-indigo-300">{data.topic}</span></p>
